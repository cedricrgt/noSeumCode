# Rule 05 – Modern JavaScript ES6+ Best Practices
...
## ES6+ Development Checklist

- [ ] All variables declared with `const` (or `let` if needed).
- [ ] No `var` used anywhere.
- [ ] Arrow functions for callbacks and array methods.
- [ ] Template literals for string interpolation.
- [ ] Destructuring for function parameters and assignments.
- [ ] Spread operator for cloning and merging.
- [ ] Async/await for asynchronous code (no callback chains).
- [ ] Try/catch for error handling in async functions.
- [ ] ES6 import/export for module organization.
- [ ] Array methods (map, filter, reduce) for transformations.
- [ ] Optional chaining (`?.`) for safe property access.
- [ ] Nullish coalescing (`??`) for default values.
- [ ] Classes for OOP (if needed).
