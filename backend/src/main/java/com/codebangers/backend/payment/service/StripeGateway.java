...
public interface StripeGateway {
    ...
    /**
     * Crée une session de paiement hébergée Stripe Checkout pour un utilisateur et un cours donné.
     *
     ...
     * @return Les détails de la session créée (sessionId, sessionUrl, montant, devise)
     */
